...
class ExpenseTrackerApp:
    def __init__(self, root):
        ...
        self.expenses = []
        self.categories = ["Rent", "Groceries", "Entertainment", "Transportation",
                           "Credit Cards", "Social", "Bills & Utilities"]
    ...
    def create_widgets(self):
        ...
        # Display frame
        display_frame = ttk.LabelFrame(main_frame, text="Expenses & Budget", padding="10")
